...
impl Payload {
  ...
  pub const OtaBeginRequest: Self = Self(21);
  pub const OtaChunkRequest: Self = Self(22);
  pub const OtaFinalizeRequest: Self = Self(23);
  pub const OtaResponse: Self = Self(24);
  pub const GetDiagnosticsRequest: Self = Self(25);
  pub const ClearDiagnosticsRequest: Self = Self(26);
  pub const DiagnosticsResponse: Self = Self(27);
